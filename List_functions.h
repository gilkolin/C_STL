...
/** 
 * @brief Predicate function returns a non-zero value if predicate holds for element
 *
 * @param _element : element to test
 * @param _context : context to be used
 * @return non-zero if predicate holds
 */
 ...
 * 
 * @warning this will remove all merged items from source ranges.
 * O(?)
 *  
 */
